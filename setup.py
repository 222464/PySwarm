...
class install_subclass(install):
    description = "Building the PySwarm C++ library, generating SWiG bindings, and installing neo"
...
class build_ext_subclass(build_ext):
    description = "Building the C-extension for PySwarm with CMake"
    ...
    def get_ext_path(self, name):
        ...
        package_dir = build_py.get_package_dir('pyswarm')
    ...
    def build_extensions(self):
        ...
        if not self.inplace:
            ...
            self._found_names = []
            built_ext = self.get_ext_name("_pyswarm")
...
setup(
    name="pyswarm",
    version="1.0.0",
    description="Python bindings for the PySwarm library",
    long_description='https://github.com/ogmacorp/PySwarm',
